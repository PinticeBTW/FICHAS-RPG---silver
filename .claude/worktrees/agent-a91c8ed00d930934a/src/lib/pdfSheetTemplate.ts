...
export const pdfSheetTemplateFields: PdfSheetTemplateField[] = [
  ...
  ...buildSkillFields(),
  { name: 'PV', widgetIndex: 0, page: 2, x: 76, y: 173, width: 48, height: 29 },
  { name: 'PV-TEMP', widgetIndex: 0, page: 2, x: 168, y: 173, width: 48, height: 29 },
  { name: 'PV-ATUAL', widgetIndex: 0, page: 2, x: 76, y: 147, width: 48, height: 28 },
  { name: 'PV-ATUAL-TEMP', widgetIndex: 0, page: 2, x: 168, y: 147, width: 48, height: 28 },
  { name: 'PS', widgetIndex: 0, page: 2, x: 76, y: 119, width: 48, height: 30 },
  { name: 'PS-TEMP', widgetIndex: 0, page: 2, x: 168, y: 119, width: 48, height: 30 },
  { name: 'PS-ATUAL', widgetIndex: 0, page: 2, x: 76, y: 93, width: 48, height: 28 },
  { name: 'PS-ATUAL-TEMP', widgetIndex: 0, page: 2, x: 168, y: 93, width: 48, height: 28 },
  { name: 'PE', widgetIndex: 0, page: 2, x: 76, y: 65, width: 48, height: 30 },
  { name: 'PE-TEMP', widgetIndex: 0, page: 2, x: 168, y: 65, width: 48, height: 30 },
  { name: 'PE-ATUAL', widgetIndex: 0, page: 2, x: 76, y: 38, width: 48, height: 30 },
  { name: 'PE-ATUAL-TEMP', widgetIndex: 0, page: 2, x: 168, y: 38, width: 48, height: 30 },
